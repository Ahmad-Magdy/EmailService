...
{
    public class MailGunProviderService
    {
        public class MailGunProvider : IEmailProvider
        {
            ILogger<MailGunProvider> _logger;
            private HttpClient _httpClient;
            private IOptionsMonitor<ConfigOptions> _emailProvidersConfig;

            public MailGunProvider(IHttpClientFactory httpClientFactory, IOptionsMonitor<ConfigOptions> emailProvidersConfig, ILogger<MailGunProvider> logger)
            {
